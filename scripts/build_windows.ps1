...
$PackagedSelfTest = Join-Path $ArtifactRoot 'packaged-self-test-v0349.json'
$PackagedCompactResource = Join-Path $ArtifactRoot 'packaged-compact-resource-v0349.json'
$PackagedWindowsStartup = Join-Path $ArtifactRoot 'packaged-windows-startup-v0349.json'
$PoseClickMask = Join-Path $ArtifactRoot 'pose-click-mask-v0349.json'
...
# Generate the complete v0.3.49 evidence set in dependency order.  Removing
...
Write-Output 'Built Lilies v0.3.49 and generated packaged self-test, compact-resource, Windows startup and pose click-mask evidence.'
