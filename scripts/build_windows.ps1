...
$PackagedSelfTest = Join-Path $ArtifactRoot 'packaged-self-test-v0347.json'
$PackagedCompactResource = Join-Path $ArtifactRoot 'packaged-compact-resource-v0347.json'
$PackagedWindowsStartup = Join-Path $ArtifactRoot 'packaged-windows-startup-v0347.json'
$PoseClickMask = Join-Path $ArtifactRoot 'pose-click-mask-v0347.json'
...
# Generate the complete v0.3.47 evidence set in dependency order.  Removing
...
Write-Output 'Built Lilies v0.3.47 and generated packaged self-test, compact-resource, Windows startup and pose click-mask evidence.'
