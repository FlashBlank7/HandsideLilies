...
$PackagedSelfTest = Join-Path $ArtifactRoot 'packaged-self-test-v0350.json'
$PackagedCompactResource = Join-Path $ArtifactRoot 'packaged-compact-resource-v0350.json'
$PackagedWindowsStartup = Join-Path $ArtifactRoot 'packaged-windows-startup-v0350.json'
$PoseClickMask = Join-Path $ArtifactRoot 'pose-click-mask-v0350.json'
...
# Generate the complete v0.3.50 evidence set in dependency order.  Removing
...
Write-Output 'Built Lilies v0.3.50 and generated packaged self-test, compact-resource, Windows startup and pose click-mask evidence.'
