...
$PackagedSelfTest = Join-Path $ArtifactRoot 'packaged-self-test-v0348.json'
$PackagedCompactResource = Join-Path $ArtifactRoot 'packaged-compact-resource-v0348.json'
$PackagedWindowsStartup = Join-Path $ArtifactRoot 'packaged-windows-startup-v0348.json'
$PoseClickMask = Join-Path $ArtifactRoot 'pose-click-mask-v0348.json'
...
# Generate the complete v0.3.48 evidence set in dependency order.  Removing
...
Write-Output 'Built Lilies v0.3.48 and generated packaged self-test, compact-resource, Windows startup and pose click-mask evidence.'
