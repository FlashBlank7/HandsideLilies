...
$FileVersion = '0.3.18.0'
$PackagedSelfTest = Join-Path $CandidateRoot 'artifacts\packaged-self-test-v0318.json'
$PackagedCompactResource = Join-Path $CandidateRoot 'artifacts\packaged-compact-resource-v0318.json'
...
if ([int]$compactResource.schemaVersion -ne 1 -or
    ...
    throw 'Packaged compact resource report did not satisfy the v0.3.18 release gate.'
}
...
$AdditionalFiles = @(
    ...
    'artifacts\packaged-compact-resource-v0318.json'
)

& $Engine `
    -FormalRoot $FormalRoot `
    -ReleaseVersion $ReleaseVersion `
    -PromotionScript 'scripts\promote_v0318.ps1' `
    -PackagedReport 'artifacts\packaged-self-test-v0318.json' `
