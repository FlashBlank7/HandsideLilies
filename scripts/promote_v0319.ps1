...
$FileVersion = '0.3.19.0'
$PackagedSelfTest = Join-Path $CandidateRoot 'artifacts\packaged-self-test-v0319.json'
$PackagedCompactResource = Join-Path $CandidateRoot 'artifacts\packaged-compact-resource-v0319.json'
...
if ([int]$compactResource.schemaVersion -ne 1 -or
    ...
    throw 'Packaged compact resource report did not satisfy the v0.3.19 release gate.'
}
...
$AdditionalFiles = @(
    ...
    'artifacts\packaged-compact-resource-v0319.json'
)

& $Engine `
    -FormalRoot $FormalRoot `
    -ReleaseVersion $ReleaseVersion `
    -PromotionScript 'scripts\promote_v0319.ps1' `
    -PackagedReport 'artifacts\packaged-self-test-v0319.json' `
