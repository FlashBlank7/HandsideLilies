...
$ReleaseVersion = '0.3.20'
$FileVersion = '0.3.20.0'
$PackagedSelfTest = Join-Path $CandidateRoot 'artifacts\packaged-self-test-v0320.json'
$PackagedCompactResource = Join-Path $CandidateRoot 'artifacts\packaged-compact-resource-v0320.json'
...
if ([int]$compactResource.schemaVersion -ne 1 -or
    ...
    throw 'Packaged compact resource report did not satisfy the v0.3.20 release gate.'
}
...
$AdditionalFiles = @(
    ...
    'artifacts\packaged-compact-resource-v0320.json'
)

& $Engine `
    -FormalRoot $FormalRoot `
    -ReleaseVersion $ReleaseVersion `
    -PromotionScript 'scripts\promote_v0320.ps1' `
    -PackagedReport 'artifacts\packaged-self-test-v0320.json' `
