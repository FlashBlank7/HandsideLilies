...
$ReleaseVersion = '0.3.34'
$FileVersion = '0.3.34.0'
$PackagedSelfTest = Join-Path $CandidateRoot 'artifacts\packaged-self-test-v0334.json'
$PackagedCompactResource = Join-Path $CandidateRoot 'artifacts\packaged-compact-resource-v0334.json'
$PackagedWindowsStartup = Join-Path $CandidateRoot 'artifacts\packaged-windows-startup-v0334.json'
$PoseClickMaskReport = Join-Path $CandidateRoot 'artifacts\pose-click-mask-v0334.json'
...
$HistoricalV0333 = Join-Path $CandidateRoot 'scripts\promote_v0333.ps1'
$HistoricalV0333Sha256 = '672c13e50e5b84f8727b1207f2832c217304970f9da5b7ec359afcb7b7052c1a'

if (-not (Test-Path -LiteralPath $HistoricalV0333 -PathType Leaf)) {
    throw "Historical v0.3.33 promotion wrapper is missing: $HistoricalV0333"
}
$historicalV0333Actual = (
    Get-FileHash -LiteralPath $HistoricalV0333 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0333Actual -cne $HistoricalV0333Sha256) {
    throw "Historical v0.3.33 promotion wrapper changed: $historicalV0333Actual"
}
...
if ([int]$compactResource.schemaVersion -ne 1 -or
    ...
    throw 'Packaged compact resource report did not satisfy the v0.3.34 release gate.'
}
...
if ([int]$windowsStartup.schemaVersion -ne 1 -or
    ...
    throw 'Packaged Windows startup report did not satisfy the v0.3.34 release gate.'
}
...
& $Engine `
    ...
    -PromotionScript 'scripts\promote_v0334.ps1' `
    -PackagedReport 'artifacts\packaged-self-test-v0334.json' `
    -AdditionalFiles $AdditionalFiles

# Keep an explicit v0.3.34 checksum fence for every source, gate and artwork
