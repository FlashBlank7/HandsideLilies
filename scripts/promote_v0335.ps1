...
$ReleaseVersion = '0.3.35'
$FileVersion = '0.3.35.0'
$PackagedSelfTest = Join-Path $CandidateRoot 'artifacts\packaged-self-test-v0335.json'
$PackagedCompactResource = Join-Path $CandidateRoot 'artifacts\packaged-compact-resource-v0335.json'
$PackagedWindowsStartup = Join-Path $CandidateRoot 'artifacts\packaged-windows-startup-v0335.json'
$PoseClickMaskReport = Join-Path $CandidateRoot 'artifacts\pose-click-mask-v0335.json'
...
$HistoricalV0334 = Join-Path $CandidateRoot 'scripts\promote_v0334.ps1'
$HistoricalV0334Sha256 = 'c0506816bd3d5325bf19a1f57b1af03a90edffd38848666b5d175ad54d0eb9d2'

if (-not (Test-Path -LiteralPath $HistoricalV0334 -PathType Leaf)) {
    throw "Historical v0.3.34 promotion wrapper is missing: $HistoricalV0334"
}
$historicalV0334Actual = (
    Get-FileHash -LiteralPath $HistoricalV0334 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0334Actual -cne $HistoricalV0334Sha256) {
    throw "Historical v0.3.34 promotion wrapper changed: $historicalV0334Actual"
}
...
if ([int]$compactResource.schemaVersion -ne 1 -or
    ...
    throw 'Packaged compact resource report did not satisfy the v0.3.35 release gate.'
}
...
if ([int]$windowsStartup.schemaVersion -ne 1 -or
    ...
    throw 'Packaged Windows startup report did not satisfy the v0.3.35 release gate.'
}
...
& $Engine `
    ...
    -PromotionScript 'scripts\promote_v0335.ps1' `
    -PackagedReport 'artifacts\packaged-self-test-v0335.json' `
    -AdditionalFiles $AdditionalFiles

# Keep an explicit v0.3.35 checksum fence for every source, gate and artwork
