...
$ReleaseVersion = '0.3.36'
$FileVersion = '0.3.36.0'
$PackagedSelfTest = Join-Path $CandidateRoot 'artifacts\packaged-self-test-v0336.json'
$PackagedCompactResource = Join-Path $CandidateRoot 'artifacts\packaged-compact-resource-v0336.json'
$PackagedWindowsStartup = Join-Path $CandidateRoot 'artifacts\packaged-windows-startup-v0336.json'
$PoseClickMaskReport = Join-Path $CandidateRoot 'artifacts\pose-click-mask-v0336.json'
...
$HistoricalV0335 = Join-Path $CandidateRoot 'scripts\promote_v0335.ps1'
$HistoricalV0335Sha256 = '684239620a3ebb67f625a61124e3cf26c94fb54392a34689d116bb9b3532e37e'

if (-not (Test-Path -LiteralPath $HistoricalV0335 -PathType Leaf)) {
    throw "Historical v0.3.35 promotion wrapper is missing: $HistoricalV0335"
}
$historicalV0335Actual = (
    Get-FileHash -LiteralPath $HistoricalV0335 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0335Actual -cne $HistoricalV0335Sha256) {
    throw "Historical v0.3.35 promotion wrapper changed: $historicalV0335Actual"
}
...
if ([int]$compactResource.schemaVersion -ne 1 -or
    ...
    throw 'Packaged compact resource report did not satisfy the v0.3.36 release gate.'
}
...
if ([int]$windowsStartup.schemaVersion -ne 1 -or
    ...
    throw 'Packaged Windows startup report did not satisfy the v0.3.36 release gate.'
}
...
& $Engine `
    ...
    -PromotionScript 'scripts\promote_v0336.ps1' `
    -PackagedReport 'artifacts\packaged-self-test-v0336.json' `
    -AdditionalFiles $AdditionalFiles

# Keep an explicit v0.3.36 checksum fence for every source, gate and artwork
