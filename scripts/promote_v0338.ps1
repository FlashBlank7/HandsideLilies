...
$PackagedSelfTest = Join-Path $CandidateRoot 'artifacts\packaged-self-test-v0338.json'
$PackagedCompactResource = Join-Path $CandidateRoot 'artifacts\packaged-compact-resource-v0338.json'
$PackagedWindowsStartup = Join-Path $CandidateRoot 'artifacts\packaged-windows-startup-v0338.json'
$PoseClickMaskReport = Join-Path $CandidateRoot 'artifacts\pose-click-mask-v0338.json'
...
$HistoricalV0337 = Join-Path $CandidateRoot 'scripts\promote_v0337.ps1'
$HistoricalV0337Sha256 = 'bc7c598c022be8c1d423718336466b5c126f063bff382ccdd1e292d1981b81de'

if (-not (Test-Path -LiteralPath $HistoricalV0337 -PathType Leaf)) {
    throw "Historical v0.3.37 promotion wrapper is missing: $HistoricalV0337"
}
$historicalV0337Actual = (
    Get-FileHash -LiteralPath $HistoricalV0337 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0337Actual -cne $HistoricalV0337Sha256) {
    throw "Historical v0.3.37 promotion wrapper changed: $historicalV0337Actual"
}
...
if ([int]$compactResource.schemaVersion -ne 1 -or
    ...
    throw 'Packaged compact resource report did not satisfy the v0.3.38 release gate.'
}
...
if ([int]$windowsStartup.schemaVersion -ne 1 -or
    ...
    throw 'Packaged Windows startup report did not satisfy the v0.3.38 release gate.'
}
...
& $Engine `
    ...
    -PromotionScript 'scripts\promote_v0338.ps1' `
    -PackagedReport 'artifacts\packaged-self-test-v0338.json' `
    -AdditionalFiles $AdditionalFiles

# Keep an explicit v0.3.38 checksum fence for every source, gate and artwork
