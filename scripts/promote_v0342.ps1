...
$ReleaseVersion = '0.3.42'
$FileVersion = '0.3.42.0'
$PackagedSelfTest = Join-Path $CandidateRoot 'artifacts\packaged-self-test-v0342.json'
$PackagedCompactResource = Join-Path $CandidateRoot 'artifacts\packaged-compact-resource-v0342.json'
$PackagedWindowsStartup = Join-Path $CandidateRoot 'artifacts\packaged-windows-startup-v0342.json'
$PoseClickMaskReport = Join-Path $CandidateRoot 'artifacts\pose-click-mask-v0342.json'
...
if ([int]$compactResource.schemaVersion -ne 1 -or
    ...
    throw 'Packaged compact resource report did not satisfy the v0.3.42 release gate.'
}
...
if ([int]$windowsStartup.schemaVersion -ne 1 -or
    ...
    throw 'Packaged Windows startup report did not satisfy the v0.3.42 release gate.'
}
...
& $Engine `
    ...
    -PromotionScript 'scripts\promote_v0342.ps1' `
    -PackagedReport 'artifacts\packaged-self-test-v0342.json' `
    -AdditionalFiles $AdditionalFiles

# Keep an explicit v0.3.42 checksum fence for every source and release gate
# changed in this release, including the public-repository hygiene boundary.
