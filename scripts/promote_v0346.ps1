...
$ReleaseVersion = '0.3.46'
$FileVersion = '0.3.46.0'
$PackagedSelfTest = Join-Path $CandidateRoot 'artifacts\packaged-self-test-v0346.json'
$PackagedCompactResource = Join-Path $CandidateRoot 'artifacts\packaged-compact-resource-v0346.json'
$PackagedWindowsStartup = Join-Path $CandidateRoot 'artifacts\packaged-windows-startup-v0346.json'
$PoseClickMaskReport = Join-Path $CandidateRoot 'artifacts\pose-click-mask-v0346.json'
...
if ([int]$compactResource.schemaVersion -ne 1 -or
    ...
    throw 'Packaged compact resource report did not satisfy the v0.3.46 release gate.'
}
...
if ([int]$windowsStartup.schemaVersion -ne 1 -or
    ...
    throw 'Packaged Windows startup report did not satisfy the v0.3.46 release gate.'
}
...
$AdditionalFiles = @(
    ...
    'artifacts\pose-click-mask-v0346.json',
    'artifacts\packaged-self-test-v0346.json',
    'artifacts\packaged-compact-resource-v0346.json',
    'artifacts\packaged-windows-startup-v0346.json'
)
...
& $Engine `
    ...
    -PromotionScript 'scripts\promote_v0346.ps1' `
    -PackagedReport 'artifacts\packaged-self-test-v0346.json' `
    -AdditionalFiles $AdditionalFiles

# Keep an explicit v0.3.46 checksum fence for every source and release gate
