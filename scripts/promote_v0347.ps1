...
$ReleaseVersion = '0.3.47'
$FileVersion = '0.3.47.0'
$PackagedSelfTest = Join-Path $CandidateRoot 'artifacts\packaged-self-test-v0347.json'
$PackagedCompactResource = Join-Path $CandidateRoot 'artifacts\packaged-compact-resource-v0347.json'
$PackagedWindowsStartup = Join-Path $CandidateRoot 'artifacts\packaged-windows-startup-v0347.json'
$PoseClickMaskReport = Join-Path $CandidateRoot 'artifacts\pose-click-mask-v0347.json'
...
if ([int]$compactResource.schemaVersion -ne 1 -or
    ...
    throw 'Packaged compact resource report did not satisfy the v0.3.47 release gate.'
}
...
if ([int]$windowsStartup.schemaVersion -ne 1 -or
    ...
    throw 'Packaged Windows startup report did not satisfy the v0.3.47 release gate.'
}
...
& $Engine `
    ...
    -PromotionScript 'scripts\promote_v0347.ps1' `
    -PackagedReport 'artifacts\packaged-self-test-v0347.json' `
    -AdditionalFiles $AdditionalFiles

# Keep an explicit v0.3.47 checksum fence for every source and release gate
# changed in this release, including the drag interaction barrier, cancellable
# WindowCatalog walk and typed QQuickWindow visibility lifecycle.
