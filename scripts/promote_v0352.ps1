...
$ReleaseVersion = '0.3.52'
$FileVersion = '0.3.52.0'
$PackagedSelfTest = Join-Path $CandidateRoot 'artifacts\packaged-self-test-v0352.json'
$PackagedCompactResource = Join-Path $CandidateRoot 'artifacts\packaged-compact-resource-v0352.json'
$PackagedWindowsStartup = Join-Path $CandidateRoot 'artifacts\packaged-windows-startup-v0352.json'
$PoseClickMaskReport = Join-Path $CandidateRoot 'artifacts\pose-click-mask-v0352.json'
...
if ([int]$compactResource.schemaVersion -ne 1 -or
    ...
    throw 'Packaged compact resource report did not satisfy the v0.3.52 release gate.'
}
...
if ([int]$windowsStartup.schemaVersion -ne 1 -or
    ...
    throw 'Packaged Windows startup report did not satisfy the v0.3.52 release gate.'
}
...
& $Engine `
    ...
    -PromotionScript 'scripts\promote_v0352.ps1' `
    -PackagedReport 'artifacts\packaged-self-test-v0352.json' `
    -AdditionalFiles $AdditionalFiles

# Keep an explicit v0.3.52 checksum fence for every source and release gate
# changed in this release, including the bounded component-tool bridge,
# component audit results, runtime drag-proxy diagnostics and proxy hot paths.
