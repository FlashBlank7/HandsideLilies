...
$ReleaseVersion = '0.3.53'
$FileVersion = '0.3.53.0'
$PackagedSelfTest = Join-Path $CandidateRoot 'artifacts\packaged-self-test-v0353.json'
$PackagedCompactResource = Join-Path $CandidateRoot 'artifacts\packaged-compact-resource-v0353.json'
$PackagedWindowsStartup = Join-Path $CandidateRoot 'artifacts\packaged-windows-startup-v0353.json'
$PoseClickMaskReport = Join-Path $CandidateRoot 'artifacts\pose-click-mask-v0353.json'
...
if ([int]$compactResource.schemaVersion -ne 1 -or
    ...
    throw 'Packaged compact resource report did not satisfy the v0.3.53 release gate.'
}
...
if ([int]$windowsStartup.schemaVersion -ne 1 -or
    ...
    throw 'Packaged Windows startup report did not satisfy the v0.3.53 release gate.'
}
...
& $Engine `
    ...
    -PromotionScript 'scripts\promote_v0353.ps1' `
    -PackagedReport 'artifacts\packaged-self-test-v0353.json' `
    -AdditionalFiles $AdditionalFiles

# Keep an explicit v0.3.53 checksum fence for every source and release gate
# changed in this release, including the quick-drag event-time handoff,
# pre-start pointer/release contracts and version-aligned release gates.
