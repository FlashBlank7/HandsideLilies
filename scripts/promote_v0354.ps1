...
$ReleaseVersion = '0.3.54'
$FileVersion = '0.3.54.0'
$PackagedSelfTest = Join-Path $CandidateRoot 'artifacts\packaged-self-test-v0354.json'
$PackagedCompactResource = Join-Path $CandidateRoot 'artifacts\packaged-compact-resource-v0354.json'
$PackagedWindowsStartup = Join-Path $CandidateRoot 'artifacts\packaged-windows-startup-v0354.json'
$PoseClickMaskReport = Join-Path $CandidateRoot 'artifacts\pose-click-mask-v0354.json'
...
$HistoricalV0339 = Join-Path $CandidateRoot 'scripts\promote_v0339.ps1'
$HistoricalV0339Sha256 = 'ebb02dd3b850823a724499a4f3011fcdaa9ef2b015ea9b367fb01454f5a605d7'
$HistoricalV0340 = Join-Path $CandidateRoot 'scripts\promote_v0340.ps1'
$HistoricalV0340Sha256 = '97fb51e1164410eacabb02b463f6f8d1f49b614eb02b6afdb3b6853a65d3088c'
$HistoricalV0341 = Join-Path $CandidateRoot 'scripts\promote_v0341.ps1'
$HistoricalV0341Sha256 = '409d0e8ecccf0e32d1559edd4d015ff7b5fb2e143c76cf5d4a26c0d2cf4eb718'
$HistoricalV0342 = Join-Path $CandidateRoot 'scripts\promote_v0342.ps1'
$HistoricalV0342Sha256 = 'f024f3cc081ab889cdd8a7d08841450a035707767a4dc34b6867f5b08353c758'
$HistoricalV0343 = Join-Path $CandidateRoot 'scripts\promote_v0343.ps1'
$HistoricalV0343Sha256 = '5e33a320d55ae9c4d50a66c2a0b0743a7afb29e379055b7a30aef911aa95f132'
$HistoricalV0344 = Join-Path $CandidateRoot 'scripts\promote_v0344.ps1'
$HistoricalV0344Sha256 = 'f7d22aa18c36166e7b8da19a7c053e6a28ae0b80c052fc37b3e3c4ad1400500a'
$HistoricalV0345 = Join-Path $CandidateRoot 'scripts\promote_v0345.ps1'
$HistoricalV0345Sha256 = '6e7b7563b65552b2463b34c0b9c5b96dd26829828871d5ea36a2884aa8a76489'
$HistoricalV0346 = Join-Path $CandidateRoot 'scripts\promote_v0346.ps1'
$HistoricalV0346Sha256 = '6bbd72104c64774e09f64087adc2461fc5a3a844a8279b6d2fb1e639d93ac267'
$HistoricalV0347 = Join-Path $CandidateRoot 'scripts\promote_v0347.ps1'
$HistoricalV0347Sha256 = 'dd1195d6076e7bdf23c247c866d2b0ab677a67da8a0edc28944a162635c556f4'
$HistoricalV0348 = Join-Path $CandidateRoot 'scripts\promote_v0348.ps1'
$HistoricalV0348Sha256 = 'bfebcc9b9a45c4ff6f12b4bb45e25d790c88aa7fb207c24e1cba2fd4bf06a6b4'
$HistoricalV0349 = Join-Path $CandidateRoot 'scripts\promote_v0349.ps1'
$HistoricalV0349Sha256 = 'e301a187a9937fb5344ab2c63a7e8c2c35738f18f8c12d80825f5d7d928f81e7'
$HistoricalV0350 = Join-Path $CandidateRoot 'scripts\promote_v0350.ps1'
$HistoricalV0350Sha256 = 'f554cd746adbd9caac582c88b3e080e3ba91ff9375f1522704eef14a36805bff'
$HistoricalV0351 = Join-Path $CandidateRoot 'scripts\promote_v0351.ps1'
$HistoricalV0351Sha256 = 'd4dbfaadbe5bc46681fffc9a282542aef5690c08bd9192941bd15523879ca27f'
$HistoricalV0352 = Join-Path $CandidateRoot 'scripts\promote_v0352.ps1'
$HistoricalV0352Sha256 = 'ce8c69801e4e07aa9ad8c8dd3fbd72c95f1d1032dc9137a0b2383f6251bae66d'
$HistoricalV0353 = Join-Path $CandidateRoot 'scripts\promote_v0353.ps1'
$HistoricalV0353Sha256 = 'f3ddbdea136df4e2710f7f5279f5644f2f269dfc15431f819bb1204a3fa07136'
...
if (-not (Test-Path -LiteralPath $HistoricalV0339 -PathType Leaf)) {
    throw "Historical v0.3.39 promotion wrapper is missing: $HistoricalV0339"
}
$historicalV0339Actual = (
    Get-FileHash -LiteralPath $HistoricalV0339 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0339Actual -cne $HistoricalV0339Sha256) {
    throw "Historical v0.3.39 promotion wrapper changed: $historicalV0339Actual"
}

if (-not (Test-Path -LiteralPath $HistoricalV0340 -PathType Leaf)) {
    throw "Historical v0.3.40 promotion wrapper is missing: $HistoricalV0340"
}
$historicalV0340Actual = (
    Get-FileHash -LiteralPath $HistoricalV0340 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0340Actual -cne $HistoricalV0340Sha256) {
    throw "Historical v0.3.40 promotion wrapper changed: $historicalV0340Actual"
}

if (-not (Test-Path -LiteralPath $HistoricalV0341 -PathType Leaf)) {
    throw "Historical v0.3.41 promotion wrapper is missing: $HistoricalV0341"
}
$historicalV0341Actual = (
    Get-FileHash -LiteralPath $HistoricalV0341 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0341Actual -cne $HistoricalV0341Sha256) {
    throw "Historical v0.3.41 promotion wrapper changed: $historicalV0341Actual"
}

if (-not (Test-Path -LiteralPath $HistoricalV0342 -PathType Leaf)) {
    throw "Historical v0.3.42 promotion wrapper is missing: $HistoricalV0342"
}
$historicalV0342Actual = (
    Get-FileHash -LiteralPath $HistoricalV0342 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0342Actual -cne $HistoricalV0342Sha256) {
    throw "Historical v0.3.42 promotion wrapper changed: $historicalV0342Actual"
}

if (-not (Test-Path -LiteralPath $HistoricalV0343 -PathType Leaf)) {
    throw "Historical v0.3.43 promotion wrapper is missing: $HistoricalV0343"
}
$historicalV0343Actual = (
    Get-FileHash -LiteralPath $HistoricalV0343 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0343Actual -cne $HistoricalV0343Sha256) {
    throw "Historical v0.3.43 promotion wrapper changed: $historicalV0343Actual"
}

if (-not (Test-Path -LiteralPath $HistoricalV0344 -PathType Leaf)) {
    throw "Historical v0.3.44 promotion wrapper is missing: $HistoricalV0344"
}
$historicalV0344Actual = (
    Get-FileHash -LiteralPath $HistoricalV0344 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0344Actual -cne $HistoricalV0344Sha256) {
    throw "Historical v0.3.44 promotion wrapper changed: $historicalV0344Actual"
}

if (-not (Test-Path -LiteralPath $HistoricalV0345 -PathType Leaf)) {
    throw "Historical v0.3.45 promotion wrapper is missing: $HistoricalV0345"
}
$historicalV0345Actual = (
    Get-FileHash -LiteralPath $HistoricalV0345 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0345Actual -cne $HistoricalV0345Sha256) {
    throw "Historical v0.3.45 promotion wrapper changed: $historicalV0345Actual"
}

if (-not (Test-Path -LiteralPath $HistoricalV0346 -PathType Leaf)) {
    throw "Historical v0.3.46 promotion wrapper is missing: $HistoricalV0346"
}
$historicalV0346Actual = (
    Get-FileHash -LiteralPath $HistoricalV0346 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0346Actual -cne $HistoricalV0346Sha256) {
    throw "Historical v0.3.46 promotion wrapper changed: $historicalV0346Actual"
}

if (-not (Test-Path -LiteralPath $HistoricalV0347 -PathType Leaf)) {
    throw "Historical v0.3.47 promotion wrapper is missing: $HistoricalV0347"
}
$historicalV0347Actual = (
    Get-FileHash -LiteralPath $HistoricalV0347 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0347Actual -cne $HistoricalV0347Sha256) {
    throw "Historical v0.3.47 promotion wrapper changed: $historicalV0347Actual"
}

if (-not (Test-Path -LiteralPath $HistoricalV0348 -PathType Leaf)) {
    throw "Historical v0.3.48 promotion wrapper is missing: $HistoricalV0348"
}
$historicalV0348Actual = (
    Get-FileHash -LiteralPath $HistoricalV0348 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0348Actual -cne $HistoricalV0348Sha256) {
    throw "Historical v0.3.48 promotion wrapper changed: $historicalV0348Actual"
}

if (-not (Test-Path -LiteralPath $HistoricalV0349 -PathType Leaf)) {
    throw "Historical v0.3.49 promotion wrapper is missing: $HistoricalV0349"
}
$historicalV0349Actual = (
    Get-FileHash -LiteralPath $HistoricalV0349 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0349Actual -cne $HistoricalV0349Sha256) {
    throw "Historical v0.3.49 promotion wrapper changed: $historicalV0349Actual"
}

if (-not (Test-Path -LiteralPath $HistoricalV0350 -PathType Leaf)) {
    throw "Historical v0.3.50 promotion wrapper is missing: $HistoricalV0350"
}
$historicalV0350Actual = (
    Get-FileHash -LiteralPath $HistoricalV0350 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0350Actual -cne $HistoricalV0350Sha256) {
    throw "Historical v0.3.50 promotion wrapper changed: $historicalV0350Actual"
}

if (-not (Test-Path -LiteralPath $HistoricalV0351 -PathType Leaf)) {
    throw "Historical v0.3.51 promotion wrapper is missing: $HistoricalV0351"
}
$historicalV0351Actual = (
    Get-FileHash -LiteralPath $HistoricalV0351 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0351Actual -cne $HistoricalV0351Sha256) {
    throw "Historical v0.3.51 promotion wrapper changed: $historicalV0351Actual"
}

if (-not (Test-Path -LiteralPath $HistoricalV0352 -PathType Leaf)) {
    throw "Historical v0.3.52 promotion wrapper is missing: $HistoricalV0352"
}
$historicalV0352Actual = (
    Get-FileHash -LiteralPath $HistoricalV0352 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0352Actual -cne $HistoricalV0352Sha256) {
    throw "Historical v0.3.52 promotion wrapper changed: $historicalV0352Actual"
}


if (-not (Test-Path -LiteralPath $HistoricalV0353 -PathType Leaf)) {
    throw "Historical v0.3.53 promotion wrapper is missing: $HistoricalV0353"
}
$historicalV0353Actual = (
    Get-FileHash -LiteralPath $HistoricalV0353 -Algorithm SHA256
).Hash.ToLowerInvariant()
if ($historicalV0353Actual -cne $HistoricalV0353Sha256) {
    throw "Historical v0.3.53 promotion wrapper changed: $historicalV0353Actual"
}
...
function Assert-LiveCompactResourceSnapshot([object]$Report) {
    Assert-JsonBoolean $Report 'sampledWhileAlive' $true 'compactResource'
    foreach ($name in @('workingSetMiB', 'privateMiB')) {
        $value = Get-RequiredJsonNumber $Report $name 'compactResource'
        if ([double]::IsNaN($value) -or [double]::IsInfinity($value) -or $value -le 0) {
            throw "compactResource.$name must be finite and positive."
        }
    }
    foreach ($name in @('threads', 'handles', 'sampledProcessId')) {
        if ((Get-RequiredJsonInteger $Report $name 'compactResource') -le 0) {
            throw "compactResource.$name must be positive."
        }
    }
}
...
if ([int]$compactResource.schemaVersion -ne 1 -or
    ...
    throw 'Packaged compact resource report did not satisfy the v0.3.54 release gate.'
}
...
Assert-LiveCompactResourceSnapshot $compactResource
...
if ([int]$windowsStartup.schemaVersion -ne 1 -or
    ...
    throw 'Packaged Windows startup report did not satisfy the v0.3.54 release gate.'
}
...
$watcherStartCount = Get-RequiredJsonInteger $windowsStartup 'systemMoveWatcherStartCount' 'windowsStartup'
$watcherEndCount = Get-RequiredJsonInteger $windowsStartup 'systemMoveWatcherEndCount' 'windowsStartup'
if ($nativeHitTestCount -lt 1 -or $nativeDispatchCount -lt $nativeHitTestCount -or
    $eventLoopTicks -lt 4 -or $watcherStartCount -lt 1 -or
    $watcherEndCount -lt 1) {
...
$AdditionalFiles = @(
    'tests\test_native_drag_hotpath_v0354.py',
    'src\lilies\root_system_move_guard.py',
    'tests\test_root_system_move_guard_v0354.py',
    'tests\test_system_move_watcher_v0354.py',
    'qml\WheelStepAccumulator.qml',
    'scripts\verify_connector_policy_hydration.py',
    'src\lilies\connectors\runtime.py',
    'tests\test_connector_runtime_v03.py',
    'tests\test_connector_policy_hydration_v0354.py',
    'tests\test_fixed_data_root_v0354.py',
    'tests\test_high_resolution_wheel_v0354.py',
    '.gitignore',
    'LiliesInTheBox.spec',
    'main.py',
    'pyproject.toml',
    ...
    'scripts\promote_v0341.ps1',
    'scripts\promote_v0342.ps1',
    'scripts\promote_v0343.ps1',
    'scripts\promote_v0344.ps1',
    'scripts\promote_v0345.ps1',
    'scripts\promote_v0346.ps1',
    'scripts\promote_v0347.ps1',
    'scripts\promote_v0348.ps1',
    'scripts\promote_v0349.ps1',
    'scripts\promote_v0350.ps1',
    'scripts\promote_v0351.ps1',
    'scripts\promote_v0352.ps1',
    'scripts\promote_v0353.ps1',
    'scripts\promote_v0354.ps1',
    'qml\Main.qml',
    ...
    'src\lilies\app.py',
    'src\lilies\drag_proxy_snapshot.py',
    'src\lilies\windows_drag_proxy.py',
    'src\lilies\paths.py',
    ...
    'src\lilies\core\component_tool_bridge.py',
    ...
    'src\lilies\core\input_pulse.py',
    'src\lilies\core\productivity.py',
    'src\lilies\core\shell.py',
    'src\lilies\core\socket_server.py',
    'src\lilies\core\themes.py',
    'src\lilies\core\window_catalog.py',
    'src\lilies\core\window_icons.py',
    'src\lilies\core\windows.py',
    ...
    'tests\test_cord_reflow_coalescing.py',
    ...
    'tests\test_component_tool_bridge_v0350.py',
    ...
    'tests\test_database_connection_session_v0346.py',
    ...
    'tests\test_drag_proxy_contract_v0348.py',
    'tests\test_drag_proxy_snapshot.py',
    'tests\test_windows_drag_proxy.py',
    ...
    'tests\test_window_catalog_v03.py',
    ...
    'tests\test_companion_interaction_barrier_v0346.py',
    ...
    'artifacts\pose-click-mask-v0341.json',
    'artifacts\packaged-self-test-v0341.json',
    'artifacts\packaged-compact-resource-v0341.json',
    'artifacts\packaged-windows-startup-v0341.json',
    'artifacts\pose-click-mask-v0342.json',
    'artifacts\packaged-self-test-v0342.json',
    'artifacts\packaged-compact-resource-v0342.json',
    'artifacts\packaged-windows-startup-v0342.json',
    'artifacts\pose-click-mask-v0343.json',
    'artifacts\packaged-self-test-v0343.json',
    'artifacts\packaged-compact-resource-v0343.json',
    'artifacts\packaged-windows-startup-v0343.json',
    'artifacts\pose-click-mask-v0344.json',
    'artifacts\packaged-self-test-v0344.json',
    'artifacts\packaged-compact-resource-v0344.json',
    'artifacts\packaged-windows-startup-v0344.json',
    'artifacts\pose-click-mask-v0345.json',
    'artifacts\packaged-self-test-v0345.json',
    'artifacts\packaged-compact-resource-v0345.json',
    'artifacts\packaged-windows-startup-v0345.json',
    'artifacts\pose-click-mask-v0347.json',
    'artifacts\packaged-self-test-v0347.json',
    'artifacts\packaged-compact-resource-v0347.json',
    'artifacts\packaged-windows-startup-v0347.json',
    'artifacts\pose-click-mask-v0348.json',
    'artifacts\packaged-self-test-v0348.json',
    'artifacts\packaged-compact-resource-v0348.json',
    'artifacts\packaged-windows-startup-v0348.json',
    'artifacts\pose-click-mask-v0349.json',
    'artifacts\packaged-self-test-v0349.json',
    'artifacts\packaged-compact-resource-v0349.json',
    'artifacts\packaged-windows-startup-v0349.json',
    'artifacts\pose-click-mask-v0350.json',
    'artifacts\packaged-self-test-v0350.json',
    'artifacts\packaged-compact-resource-v0350.json',
    'artifacts\packaged-windows-startup-v0350.json',
    'artifacts\pose-click-mask-v0351.json',
    'artifacts\packaged-self-test-v0351.json',
    'artifacts\packaged-compact-resource-v0351.json',
    'artifacts\packaged-windows-startup-v0351.json',
    'artifacts\pose-click-mask-v0352.json',
    'artifacts\packaged-self-test-v0352.json',
    'artifacts\packaged-compact-resource-v0352.json',
    'artifacts\packaged-windows-startup-v0352.json',
    'artifacts\pose-click-mask-v0353.json',
    'artifacts\packaged-self-test-v0353.json',
    'artifacts\packaged-compact-resource-v0353.json',
    'artifacts\packaged-windows-startup-v0353.json',
    'artifacts\pose-click-mask-v0354.json',
    'artifacts\packaged-self-test-v0354.json',
    'artifacts\packaged-compact-resource-v0354.json',
    'artifacts\packaged-windows-startup-v0354.json'
)
...
& $Engine `
    ...
    -PromotionScript 'scripts\promote_v0354.ps1' `
    -PackagedReport 'artifacts\packaged-self-test-v0354.json' `
    -AdditionalFiles $AdditionalFiles

# Keep an explicit v0.3.54 checksum fence for every source and release gate
# changed in this release, including real-window native dragging, high-resolution
# wheel accumulation, connector-policy hydration and the fixed F: data boundary.
