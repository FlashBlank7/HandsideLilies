...
PROMOTION = PROJECT_ROOT / "scripts" / "promote_v0332.ps1"
...
def test_v0332_cache_gate_rejects_missing_false_and_escaped_routing() -> None:
...
def test_v0332_gate_applies_cache_contract_to_both_packaged_reports() -> None:
    source = PROMOTION.read_text(encoding="utf-8")
