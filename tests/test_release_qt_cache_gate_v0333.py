...
PROMOTION = PROJECT_ROOT / "scripts" / "promote_v0333.ps1"
...
def test_v0333_cache_gate_rejects_missing_false_and_escaped_routing() -> None:
...
def test_v0333_gate_applies_cache_contract_to_both_packaged_reports() -> None:
    source = PROMOTION.read_text(encoding="utf-8")
